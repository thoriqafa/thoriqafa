...
<p>
  <img src="https://skillicons.dev/icons?i=php,laravel,codeigniter,python,delphi" />
</p>
...
Use this section to highlight the strongest repositories from the GitHub data.

### [{{project_name}}]({{project_url}})

{{project_description}}

- **Tech:** {{project_language}}
- **Why it matters:** {{project_value}}
